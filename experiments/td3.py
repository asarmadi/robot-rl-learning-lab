...
from utils.td3_training import Training
...
training      = Training(Q_old1=Q_old1, Q_old2=Q_old2, Q_new1=Q_new1, Q_new2=Q_new2, actor_old=agent_old, actor_new=agent_new, config=config)
...
for episode in range(1, n_episodes):
    ...
    while True:
        ...
        if len(replay_buffer) >= initial_n_samples:
            training.train(replay_buffer, step%update_rate)
