...
$=\sum_{a}\pi(a\mid s)\sum_{\prime s}\sum_{r} p(\prime s, r\mid s, a)[r+\gamma \mathbb{E}_{\pi}[G_{t+1}\mid S_{t+1}=\prime s]]\\
&=\sum_{a}\pi(a\mid s)\sum_{\prime s, r}p(\prime s, r \mid s, a)[r+\gamma v_{\pi}(\prime s)], for all s \in S
